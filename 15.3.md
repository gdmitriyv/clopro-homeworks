...
1. С помощью ключа в KMS необходимо зашифровать содержимое бакета:
 ...
 - с помощью ключа зашифровать содержимое бакета, созданного ранее.
   ...
   В main.tf добавлено к предыдущему заданию.

```
// --- KMS КЛЮЧ И КРИПТОГРАФИЯ ---
...
// --- YANDEX OBJECT STORAGE С ШИФРОВАНИЕМ KMS ---
...
<img width="1153" height="379" alt="image" src="https://github.com/user-attachments/assets/1948efcb-829b-4b4a-96f4-9ec5c366891e" />
